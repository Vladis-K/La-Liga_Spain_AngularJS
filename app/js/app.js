 var app = angular.module('myApp', ['ngRoute','ngAnimate','myCollapse']);

 angular.module('myCollapse', [])
     .directive('myCollapse', function($compile, $timeout) {
         return {
             restrict: 'AEC',
 ...
 // var app = angular.module('myApp', ['ngAnimate','ui.bootstrap.tpls','ui.bootstrap']);
